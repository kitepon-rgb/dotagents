...
export function makeWorkerRun(overrides = {}) {
  ...
  return {
    ...
    lineage: {
      ...
      input_digest: "b".repeat(64), approach_family_ref: "implementation-primary", shared_artifact_ids: [],
    },
...
export function makePlacementCandidate(overrides = {}) {
  ...
  return {
    ...
    lineage: {
      ...
      input_digest: "c".repeat(64), approach_family_ref: "placement-primary", shared_artifact_ids: [],
    },
