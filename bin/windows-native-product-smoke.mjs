...
import { CURRENT_WIRE_PRODUCT_IDS, postUpdateFailures } from '../lib/factory/deployment-contract.mjs';
...
export function assertWindowsNativeProductSmoke(report, runtimeArch = process.arch) {
  ...
  structural(record(products.observer, 'observer'), 'observer', 'platform');
