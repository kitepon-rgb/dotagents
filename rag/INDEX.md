...
- [models/xai-grok45-composer25.md](models/xai-grok45-composer25.md) — Grok 4.5 / Composer 2.5: 2026-08-11 公式API価格・context、CLI/OAuthとの非換算、effort非対応・aiterm 隔離設計（確度は claim 別）
