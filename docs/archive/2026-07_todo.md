...
**人手・承認待ちの全件は [PENDING_OWNER.md](2026-07_pending-owner.md) に集約**（grok login・caveat 棚卸し承認・ServerManager 正規化・Kikoeru GPL・他端末展開）。
...
- [ ] 昇格原則の適用（P5 の各リポ再生時に同時実施）。**FOX(WSL) 分の昇格候補は [P4_PROMOTION_QUEUE.md](../queue_memory-promotion.md) に起票済み（2026-07-04）＝各リポの次の作業セッションが消化**
