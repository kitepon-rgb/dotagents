...
export function buildWorkerControlObservation(input) {
  ...
  if (core.state === "dispatched") {
    ...
    if (["codex-native", "aiterm"].includes(core.source)) {
      const projection = input.projection;
      const label = core.source === "codex-native" ? "completed codex native projection" : "completed aiterm projection";
      const keys = core.source === "codex-native"
        ? ["schema_version", "executor_handle", "status", "routing_receipt", "report_ref", "evidence_refs"]
        : ["schema_version", "executor_handle", "state", "report_ref", "evidence_refs"];
