...
const TODO_STATUS_SCHEMA = "lattice.todo_status_result.v5";
...
// v4時代に束縛した既存Controlがbump直後に「束縛が1件も無い」へ落ちる。観測はv5だけを受理し、
// 束縛照合は過去版も受理する——2つは別の軸である。
const TODO_STATUS_BINDING_CONTRACT_VERSIONS = new Set([
  "lattice.todo_status_result.v4", TODO_STATUS_SCHEMA,
]);
...
const TODO_STATUS_KEYS = Object.freeze([
  ...
  "audit_pending", "member_heads", "result_digest",
]);
