...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v14";
...
function validateWorker(value, stored = true) {
  ...
  exact(value, [...common, ...location, "workflow_capabilities", "budget_reservation", "write_mode", "operation_digest", "execution_verification", "lineage", "placement_reservation", "state", "executor_handle", "executor_observation", "admission", "dispatch_evidence", "dispatch_attempt_evidence", "terminal_evidence", "result", "acceptance"], "worker_run");
...
const TRANSITION_OPERATIONS = [
  "control-init", "task-record", "registry-observation-record", "placement-reserve", "worker-run-record", "consultation-record", "worker-admit",
...
function briefManifest(manifest) {
  ...
  return {
    schema_version: "dotagents.orchestration-status-brief.v1",
...
export async function resumeCheck(input) {
  ...
  return withLock(identity, async (paths) => {
    ...
    return {
      schema_version: "dotagents.orchestration-resume-check.v1", checked_at: new Date().toISOString(),
