...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v13";
...
async function evaluatePlacementCandidate({ manifest, manifests, task, candidate, evaluatedAt }) {
  ...
  try {
    ...
    stored = structuredClone(synthetic); delete stored.workspace_cwd; stored.workspace = workspaceObject(workspace); stored.baseline_workspace_fingerprint = null;
