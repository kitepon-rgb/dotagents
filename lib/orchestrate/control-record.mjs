...
export function validateManifest(value) {
  exact(value, ["schema_version", "record_revision", "control_id", "status", "declaration", "document_refs", "tasks", "worker_runs", "consultations", "task_finalizations", "transition_receipts", "last_update"], "manifest");
...
export async function init(input) {
  ...
  return withLock(identity, async (paths) => {
    ...
    const manifest = {
      ...
      document_refs: [...input.document_refs], tasks: [], worker_runs: [], consultations: [], task_finalizations: [],
