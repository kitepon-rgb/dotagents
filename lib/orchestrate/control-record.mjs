...
function validateWorker(value, stored = true) {
  ...
  exact(value, [...common, ...location, "write_mode", "execution_verification", "lineage", "state", "executor_handle", "executor_observation", "admission", "dispatch_evidence", "dispatch_attempt_evidence", "terminal_evidence", "result", "acceptance"], "worker_run");
