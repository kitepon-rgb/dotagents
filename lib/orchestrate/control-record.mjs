...
const MANIFEST_SCHEMAS = Object.freeze([MANIFEST_SCHEMA_V25, MANIFEST_SCHEMA_V26, MANIFEST_SCHEMA_V27, MANIFEST_SCHEMA_V28, MANIFEST_SCHEMA_V29]);
...
const MIGRATION_EDGES = Object.freeze({
  ...
  [MANIFEST_SCHEMA_V29]: [MANIFEST_SCHEMA_V28],
});
