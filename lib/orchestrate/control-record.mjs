...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v16";
...
const TRANSITION_OPERATIONS = [
  ...
  "worker-observe", "worker-report-import", "consultation-observe", "campaign-record", "campaign-release", "worker-accept", "worker-reject", "task-finalize", "control-finalize", "control-archive",
];
