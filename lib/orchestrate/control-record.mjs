...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v3";
...
function validateWorker(value, stored = true) {
  ...
  exact(value, [...common, ...location, "workflow_capabilities", "write_mode", "execution_verification", "lineage", "state", "executor_handle", "executor_observation", "admission", "dispatch_evidence", "dispatch_attempt_evidence", "terminal_evidence", "result", "acceptance"], "worker_run");
