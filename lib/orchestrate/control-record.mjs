...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v21";
...
export function validateManifest(value) {
  ...
  for (let index = 0; index < value.transition_receipts.length; index++) {
    ...
    if (["placement-reserve", "worker-run-record", "worker-workspace-bind"].includes(receipt.operation) !== (receipt.subject_digest !== null)) fail("INVALID_SCHEMA", "transition subject digest is invalid for operation");
  }
