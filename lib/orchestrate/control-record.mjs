...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v6";
...
export function validateManifest(value) {
  exact(value, ["schema_version", "record_revision", "control_id", "status", "declaration", "budget", "document_refs", "tasks", "worker_runs", "consultations", "task_finalizations", "control_finalization", "transition_receipts", "last_update"], "manifest");
...
export async function init(input) {
  ...
  return withLock(identity, async (paths) => {
    ...
    const manifest = {
      ...
      budget: structuredClone(input.budget), document_refs: [...input.document_refs], tasks: [], worker_runs: [], consultations: [], task_finalizations: [], control_finalization: null,
