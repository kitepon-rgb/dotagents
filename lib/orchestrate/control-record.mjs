...
export async function resumeCheck(input) {
  ...
  return withLock(identity, async (paths) => {
    ...
    return {
      schema_version: "dotagents.orchestration-resume-check.v6", checked_at: new Date().toISOString(),
...
function workerReportSkeleton(packet, run) {
  ...
  const timestampPlaceholder = "REPLACE_WITH_RFC3339_TIMESTAMP";
  return {
    ...
    placeholders: {
      ...
      observed_at: "RFC 3339 timestampへ置換する",
