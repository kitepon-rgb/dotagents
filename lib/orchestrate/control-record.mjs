...
const MANIFEST_SCHEMA = "dotagents.orchestration-control.v7";
...
export function validateManifest(value) {
  exact(value, ["schema_version", "record_revision", "control_id", "status", "declaration", "budget", "role_effect_policy", "document_refs", "tasks", "worker_runs", "consultations", "task_finalizations", "control_finalization", "transition_receipts", "last_update"], "manifest");
  ...
  validateDeclaration(value.declaration); validateBudget(value.budget); validateRoleEffectPolicy(value.role_effect_policy); refs(value.document_refs, "manifest.document_refs");
