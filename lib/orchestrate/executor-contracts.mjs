...
function immutableContract(value) {
  const keys = ["adapter_id", "contract_version", "workflow_id", "handle_schema_id", "external", "nullable_handle", "validate_handle", "validate_capabilities"];
  ...
  if (typeof value.external !== "boolean" || typeof value.nullable_handle !== "boolean" || typeof value.validate_handle !== "function" || typeof value.validate_capabilities !== "function") throw new TypeError("executor contract has invalid validators");
