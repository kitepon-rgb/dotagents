...
async function codexIntegration(home, cwd, now) {
  ...
  try {
    ...
    const section = text.match(/^\[features\.multi_agent_v4\](?:[ \t]+#[^\n]*)?[ \t]*\n([\s\S]*?)(?=^\[|(?![\s\S]))/mu)?.[1] || '';
