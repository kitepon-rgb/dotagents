...
const V6_PRODUCT_IDS = [
  'caveat', 'throughline', 'spotter', 'lattice', 'markitdown',
  'gpt-connector', 'aiterm-mcp', 'codex-sidecar', 'servermanager',
  'claude-code', 'codex-cli', 'grok-build', 'aishell', 'observer',
];
const V7_PRODUCT_IDS = [
  'caveat', 'throughline', 'spotter', 'lattice', 'markitdown',
  'gpt-connector', 'aiterm-mcp', 'codex-sidecar', 'servermanager',
  'claude-code', 'codex-cli', 'grok-build', 'aishell', 'observer', 'peertable',
];
...
const SAFE_CONTEXT_ALLOWLIST = Object.freeze(
  Object.fromEntries([...new Set([...PRODUCT_IDS, ...V2_PRODUCT_IDS, ...V4_PRODUCT_IDS, ...V5_PRODUCT_IDS, ...V6_PRODUCT_IDS, ...V7_PRODUCT_IDS])].map((id) => [id, new Set()])),
);
