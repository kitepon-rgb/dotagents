...
更新: 2026-07-05 v4 — キャンペーン完遂（全3端末展開済み）につき、計画書から**憲章（趣旨・原則・文書の作法・定常運用）**へ改稿。v3 全文と消化記録は [docs/archive/](docs/archive/) に凍結。原則1〜10 の番号・骨子は不変（他リポ・グローバル共通憲法が番号で参照する生きた参照）。
